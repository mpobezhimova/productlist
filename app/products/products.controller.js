app.controller('productsController', function($scope,$filter, $mdDialog, $mdToast, productsFactory){
 ...
 // read products
   ...
   // }
    ...
    for (var i=0; i < 25; i++) {
        var item =  { name: 'pillow ' + i, description: 'the best pillow in the world', price: '$39' };
